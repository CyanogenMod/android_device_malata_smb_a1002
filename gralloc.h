...
/* temporary compatibility flag, remove */
#define GRALLOC_FB_READ_SUPPORTED
...
typedef struct framebuffer_device_t {
    ...
    /*
     * Read the contents of the framebuffer into <buffer>.
     *
     * Buffer must be the same width and height as the display and must NOT
     * be locked.
     *
     * The Buffer does not need to be allocated with the GRALLOC_USAGE_HW_FB
     * usage flag.
     *
     * Returns 0 on success or -errno on error.
     */
